...
public class FastScrollRecyclerView extends RecyclerView implements FastScrollDelegate.FastScrollable {
  ...
  private void init(Context context) {
    mFastScrollDelegate = createFastScrollDelegate(context);
  }
  ...
  protected FastScrollDelegate createFastScrollDelegate(Context context) {
    return new FastScrollDelegate.Builder(this).build();
  }
