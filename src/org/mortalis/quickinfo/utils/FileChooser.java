...
public class FileChooser {
  ...
  public FileChooser(Activity activity, String path) {
    File startFile = Environment.getExternalStorageDirectory();
    ...
    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
      ...
      public void onItemClick(AdapterView<?> parent, View view, int which, long id) {
        ...
        if (chosenFile.isDirectory()) {
          if (!parentClicked) scrollPos = list.getFirstVisiblePosition();
          refresh(chosenFile);
          if (parentClicked) list.setSelection(scrollPos);
        }
        else {
